...
namespace PABP_Projekat2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var employeeTerritories = await _context.EmployeeTerritories.ToListAsync();
            ...
            var rez = from et in employeeTerritories
                      ...
                      select new { Br = g.Count(), TerritoryId = g.Key, Naziv = Territories.Where(x=> x.TerritoryId == g.Key).FirstOrDefault().TerritoryDescription, Region = Regions.Where(x=>x.RegionId== Territories.Where(x => x.TerritoryId == g.Key).FirstOrDefault().RegionId).FirstOrDefault().RegionDescription };
